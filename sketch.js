...
function draw() {
  ...
  logo.setAnimation("pacman logo.png");
  logo.scale = 0.25 ;
  ...
  coin1.setAnimation(" coin.png");
  coin1.scale = 0.04 ;
  coin2.setAnimation("coin.png");
  coin2.scale = 0.04 ;
  coin3.setAnimation("coin.png");
  coin3.scale = 0.04 ;
  coin4.setAnimation("coin.png");
  coin4.scale = 0.04 ;
  coin5.setAnimation("coin.png");
  coin5.scale = 0.04 ;
  coin6.setAnimation("coin.png");
  coin6.scale = 0.04 ;
  coin7.setAnimation("coin.png");
  coin7.scale = 0.04 ;
  coin8.setAnimation("coin.png");
  coin8.scale = 0.04 ;
  coin9.setAnimation("coin.png");
  coin9.scale = 0.04 ;
  coin10.setAnimation("pacman coins.png_1");
  coin10.scale = 0.04 ;
  coin11.setAnimation("coin.png");
  coin11.scale = 0.04 ;
